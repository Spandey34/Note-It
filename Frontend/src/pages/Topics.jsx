...
export default function Topics({ selectedTopic, setSelectedTopic }) {
  ...
  useEffect(() => {
    const getTopics = async () => {
      try {
        const res = await axios.get("https://note-it-n0cc.onrender.com/topics", { 
  ...
  const handleAddTopic = async (e) => {
    ...
    const res = await axios.post("https://note-it-n0cc.onrender.com/topics/add", payload, {
      withCredentials: true,
    });
  ...
  const handleDeleteTopic = async (e) => {
    ...
    try {
      const res = await axios.post(
        `https://note-it-n0cc.onrender.com/topics/delete/${activeTopicId}`,
        {},
        { withCredentials: true }
      );
      setTopics(res.data.topics);
  ...
  const handleRenameTopic = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://note-it-n0cc.onrender.com/topics/rename/${activeTopicId}`,
        payload,
        { withCredentials: true }
      );
      setTopics(res.data.topics);
